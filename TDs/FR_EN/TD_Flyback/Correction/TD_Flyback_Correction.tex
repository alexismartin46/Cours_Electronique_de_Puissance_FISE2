...
\begin{itemize}
    \item \underline{$0 < t < \alpha T$}: T ``closed'' $\rightarrow V_T = 0$; $v_1 = E$; $v_2 = \dfrac{n_2}{n_1} E > 0$
    
    $v_D=-v_2 - V_S < 0$ $\rightarrow$ D ``reverse'' $\rightarrow i_2 = 0$;
    
    $v_1 = E = L_1 \dfrac{di_1}{dt}$ and boundary mode $\rightarrow \varphi(t=0)=0$ $\rightarrow$ $i_1(t=0) = 0$

    \item \underline{$\alpha T < t < T$}: T ``open'' $\rightarrow i_1 = 0$
    
    Flux continuity $\rightarrow$ $i_2(\alpha T^+)>0$ $\rightarrow$ D ``forward'' $\rightarrow v_2 = -V_S$; $v_1 = -\dfrac{n_1}{n_2} V_S$
