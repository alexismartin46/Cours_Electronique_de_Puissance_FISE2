...
\item Donner les formes d'ondes de la tension de sortie, de la tension sur la broche SW et du courant dans l'inductance
\item Dimensionner les composants passifs du convertisseur Buck
}{
\item Draw the electrical schematic of the Buck converter
\item Give the waveforms of the output voltage, the voltage on the SW pin, and the current in the inductor
